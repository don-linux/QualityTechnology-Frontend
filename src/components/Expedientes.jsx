...
export default function Expedientes() {
  ...
  const exportarPDF = () => {
    ...
    if (nombreUsuario.includes("ceiba")) logo = `${process.env.PUBLIC_URL}/images/ceiba.png`;
    if (nombreUsuario.includes("medellin")) logo = `${process.env.PUBLIC_URL}/images/medellin.png`;

    doc.addImage(logo, "PNG", 10, 8, 25, 25);
    doc.setFontSize(14);
    doc.text("Expedientes de Personal - RRHH", 45, 20);
    doc.setFontSize(10);
    doc.text("Control documental del personal", 45, 26);
    ...
    const filas = data.map((r) => [
      ...
      r.fc_rfc,
      r.fc_curp,
      r.fc_comprobante_estudios,
      r.fc_cv,
      r.fc_acta_nacimiento,
      r.fc_fotografia,
    ]);
    ...
    doc.text(`Generado el: ${fecha}`, 10, doc.lastAutoTable.finalY + 10);
    doc.save(`Expedientes_RRHH_${fecha}.pdf`);
  };

  // =========================================================
  // 🎨 COLORES SEGÚN ESTADO DE DOCUMENTO
  // =========================================================
      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          <Stack direction="row" spacing={2} sx={{ mt: 3 }}>
            ...
            <Button variant="outlined" color="info" onClick={exportarPDF}>
              <PictureAsPdf /> PDF
            </Button>
        ...
        >
            ...
            {data.map((r) => (
                ...
                <TableCell>
                    ...
                    color="error"
                    variant="contained"
                    onClick={() => eliminar(r.fi_expediente_id)}
                    >
