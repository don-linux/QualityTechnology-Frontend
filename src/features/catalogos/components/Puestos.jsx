      ...
      <Card sx={{ mb: 4, borderRadius: 4, boxShadow: 4, border: "1px solid #eee" }}>
        <CardContent>
          ...
          <Grid container spacing={2}>
            <Grid size={12}>
              <CampoTexto name="fc_nombre" label="Nombre del Puesto" fullWidth value={form.fc_nombre} onChange={handleChange} error={!!errors.fc_nombre} helperText={errors.fc_nombre} />
            </Grid>
          </Grid>
