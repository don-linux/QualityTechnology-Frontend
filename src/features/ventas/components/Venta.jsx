  ...
  return (
    <Box p={3}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
        Ventas agrupadas por sede, igual que en alevinaje, engorda, incubación y trazabilidad.
      </Typography>

      <TablasPorUbicacionGranja
        grupos={gruposVentas}
        renderTabla={(rows) => {
          const filas = ordenarYNumerar(rows, ["fi_venta_id"]);
          return (
