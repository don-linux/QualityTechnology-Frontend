...
| ParametrosFisicoQuimicos, InventarioAlevines, Biometrias, Medicamentos, ControlFaunaNociva, ControlVisitas, LimpiezaInstalaciones | `["busqueda"]` | Search only; `filtroConfig.busqueda` per screen |
